...
function POST_state() {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            bpu_1 = parseFloat(stateString_split[11]);
    ...
    xhttp.open("GET", "getState_rdkultra", true);
    xhttp.send();
}
...
function POST_disk() {
    ...
    xhttp.open("GET", "getDisk_rdkultra", true);
    xhttp.send();
}
...
function changeMode() {
    ...
    debounce(() => {
        ...
        xhttp.open("GET", "/mode_rdkultra?state=" + state, true);
        xhttp.send();
    }, 2000);
}
